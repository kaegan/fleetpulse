    ...
    <Card
      ...
      className={
        isOverlay
          ...
          : "touch-none [@media(pointer:coarse)]:touch-auto select-none cursor-grab shadow-card transition-all duration-150 hover:-translate-y-px hover:shadow-card-hover"
      }
      style={{
