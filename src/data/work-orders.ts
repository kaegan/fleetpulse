...
export const workOrders: WorkOrder[] = [
  ...
  // Pre-seeded PM-A intake WOs — buses that ops already scheduled out of
  // the overdue pool. They sit in stage 0 (Intake) unassigned, waiting
  // for a mechanic to pick them up. Gives the mechanic kanban lived-in
  // density and foreshadows the ops-side "Schedule PM service" action.
  {
    id: "WO-1257",
    busId: 55,
    busNumber: "055",
